...
#End Region
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        ElseIf txtChallanNo.Text = Nothing Then
            MessageBoxEx.Show("Please enter Tax no.")
            txtChallanNo.Focus()
        ElseIf txtChallanDate.Text = Nothing Then
            MessageBoxEx.Show("Please enter Tax date.")
            btnDt1.Focus()
        ...
        Else
            ...
            If Not Directory.Exists(My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\Tax") Then
                Directory.CreateDirectory(My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\Tax")
            End If
            PrintDocument2.PrinterSettings.PrintToFile = True
            PrintDocument2.PrinterSettings.PrintFileName = My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\Tax\" + txtOrderNo.Text + ".xps"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            conSqlite.Open()
            Dim daSqlite As New SQLiteDataAdapter("Select * from TAX where ID='" + cmbSelectProduct.SelectedItem.ItemValue.ToString + "'", conSqlite)
            ds.Tables.Clear()
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables("ItemSelected").Rows.Count > 0 Then
                    For Each dr As DataRow In ds.Tables("ItemSelected").Rows
                        strAll = dr.Item("TaxDetail").ToString
    ...
    Private Sub Tax_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            conSqlite.Open()
            Dim daSqlite As New SQLiteDataAdapter("Select * from PRODUCT where ItemType='3'", conSqlite)
            ds.Tables.Clear()
