Module Module1
    ...
    Friend SqliteDetails As String = "Data Source=" & My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\qq.abd;Version=3;"
    ...
    Public Function TrapKey(ByVal KCode As String) As Boolean
        ...
        End If
    End Function
    Public Function NoKey(ByVal KCode As String) As Boolean
        If (KCode >= 0 And KCode <= 255) Then
            NoKey = True
        Else
            NoKey = False
        End If
